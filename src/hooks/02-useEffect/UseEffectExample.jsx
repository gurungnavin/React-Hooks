...
const UseEffectExample = () => {
  ...
  useEffect(() => {
    fetch(url).then((response) => response.json()).then((data) => setValue(data))
  }, [value])
...
<div key={data.id} class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 my-1 mx-4">
    <a href="#">
